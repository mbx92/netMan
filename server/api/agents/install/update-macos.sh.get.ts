// GET /api/agents/install/update-macos.sh - Re-downloads the binary and restarts the
// LaunchDaemon. No token needed — the existing enrollment credentials in /etc/netman-agent are untouched.
